 ...
 *=============================================================================================*/
RadioMessageType RadioClass::Receive_Message(RadioClass * from, RadioMessageType message, RadioParameter & param)
{
	/*
 ...
 *=============================================================================================*/
RadioMessageType RadioClass::Transmit_Message(RadioMessageType message, RadioParameter & param, RadioClass * to)
{
	if (to == NULL) {
