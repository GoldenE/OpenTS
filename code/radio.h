...
class RadioClass : public MissionClass
{
	...
	public:
		...
		*/
		...
		virtual RadioMessageType Receive_Message(RadioClass * from, RadioMessageType message, RadioParameter & param) override;
		virtual RadioMessageType Transmit_Message(RadioMessageType message, RadioParameter & param=LParam, RadioClass * to=NULL);
